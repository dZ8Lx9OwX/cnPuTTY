                      ...
                      int protocol, int protcfginfo)
{
    ...
    ctrl_radiobuttons(s, "Home和End键", 'e', 2,
                      ...
                      conf_radiobutton_bool_handler,
                      I(CONF_rxvt_homeend),
                      "标准模式", I(false), "rxvt模式", I(true), NULL);
    ...
    ctrl_radiobuttons(s, "Shift/Ctrl/Alt与方向键", 'w', 2,
                      ...
                      "xterm位图风格", I(SHARROW_BITMAP), NULL);
    ...
    str = dupprintf("调整cn%s的字符画线处理方式：", appname);
    ...
    if (!midsession) {
        ...
        c = ctrl_radiobuttons(s, "代理类型：", 't', 3,
                              HELPCTX(proxy_type),
                              conf_radiobutton_handler,
                              I(CONF_proxy_type),
                              "无代理", I(PROXY_NONE),
